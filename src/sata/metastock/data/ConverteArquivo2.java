...
public class ConverteArquivo2 {
	...
	public static ArrayList convete(){
	
		ArrayList acoes = new ArrayList();
		FileInputStream file;
		try {
			file = new FileInputStream("C:\\Documents and Settings\\zfoo\\Meus documentos\\Dados historicos\\COTAHIST_A2008.TXT");
			DataInputStream myInput = new DataInputStream(file);
		     ...
		     while ((thisLine = myInput.readLine()) != null){         	
		     	...
		     	if(thisLine.substring(0,2).equals("01")){
			     	...
			     	if(acao.getCodigo().length()==7 && acao.getCodigo().substring(0,5).equalsIgnoreCase("PETRE")){
	...
	*/	    	
	...
	/*	    	 if(acao.getCodigo().equals("PETRK62")){
		    		 valor1 = Integer.parseInt(acao.getFechamento());
		    		 data1 = acao.getData();
		    		 
		    	 }
		    	 if(acao.getCodigo().equals("PETRK64")){
		    		 
		    		 valor2 = Integer.parseInt(acao.getFechamento());
		    		 data2 = acao.getData();
		    	 }
		    	 ...
		    	 String novaLinha = acao.getCodigo() + " " + acao.getFechamento() + " " + acao.getData() + " " + acao.getQtd();
	...
	public static ArrayList converte(String ac, int tamanho){
		...
		try {
			file = new FileInputStream("C:\\Documents and Settings\\zfoo\\Meus documentos\\Dados historicos\\COTAHIST_A2007.TXT");
			DataInputStream myInput = new DataInputStream(file);
		    ...
		    // System.out.println(t1);
		     ...
		     while ((thisLine = myInput.readLine()) != null){         	
		     	...
		     	if(thisLine.substring(0,2).equals("01")){
			     	...
			     	if(acao.getCodigo().length()==tamanho && acao.getCodigo().substring(0,tamanho).equalsIgnoreCase(ac)){
			     		//System.out.println("ok");
			     		acoes.add(acao);
			     	}
